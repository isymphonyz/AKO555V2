...
public class AKO555ProjectCreate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(AKO555ProjectCreate.this, dateStart, myCalendarStartDate
        ...
        inputEndDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(AKO555ProjectCreate.this, dateEnd, myCalendarEndDate
